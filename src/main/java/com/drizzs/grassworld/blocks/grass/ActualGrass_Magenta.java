...
public class ActualGrass_Magenta extends Block {
	
	public ActualGrass_Magenta(String name, Material material) {
        super(material);
    ...
    public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack)
    {
        if (!worldIn.isRemote && stack.getItem() == Items.SHEARS)
        {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(ModBlocks.ACTUALGRASS_MAGENTA, 1));
        }
        else
        {
