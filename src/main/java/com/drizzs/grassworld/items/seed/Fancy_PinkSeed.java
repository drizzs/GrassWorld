...
public class Fancy_PinkSeed extends ItemBase {
	
	public Fancy_PinkSeed(String name, CreativeTabs tab) {
        super(name, tab);
		setCreativeTab(tab);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!(stack.getItem() instanceof Fancy_PinkSeed))
        ...
        if (world.getBlockState(pos).getBlock() == Blocks.GRASS) 
        {
        	...
        	world.setBlockState(pos, ModBlocks.FANCY_PINK_GRASS.getDefaultState());
