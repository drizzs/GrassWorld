...
public class GreyEndSeed extends Item {

	public GreyEndSeed(String name, CreativeTabs tab)
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!(stack.getItem() instanceof GreyEndSeed))
        ...
        if (world.getBlockState(pos).getBlock() == Blocks.END_STONE)
        {
        	...
        	world.setBlockState(pos, ModBlocks.GREYENDGRASS.getDefaultState());
