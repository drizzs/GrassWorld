...
public class OrangeSeed extends ItemBase {
	
	public OrangeSeed(String name, CreativeTabs tab) {
        super(name, tab);
		setCreativeTab(tab);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!(stack.getItem() instanceof OrangeSeed))
        ...
        if (world.getBlockState(pos).getBlock() == Blocks.GRASS) 
        {
        	...
        	world.setBlockState(pos, ModBlocks.ORANGE_GRASS.getDefaultState());
